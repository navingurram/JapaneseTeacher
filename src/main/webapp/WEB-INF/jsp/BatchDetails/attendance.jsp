<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
    ...
    <body>
        ...
        <section id="content">
            ...
            <main>
                <div class="Container">
                    <h1 style="margin-bottom: 30px; text-align: center; font-weight: 600; font-size: 30px">ATTENDANCE
                        OF STUDENTS</h1>
                        ...
                        <div class="tablestyle">
                            <table class='MainTable'>
                                <thead class='tableheading'>
                                    <tr>
                                        <th style="width: 100px; font-weight: 800; color: white;">Date</th>
                                        <th style="font-weight: 800; color: white;">Sr No</th>
                                        <th style="font-weight: 800; color: white;">Active/Inactive</th>
                                        <th style="font-weight: 800; color: white;">Student Type
                                            Date</th>
                                        ...
                                        <th style="font-weight: 800; color: white;">Attendance Taken</th>
                                    </tr>
                                </thead>
                                <tbody class='tablebody'>
                                    <tr>
                                        ...
                                        <td style="font-weight: 500; text-align: center;"><a style="color: black;"
                                                href="viewDetails"><i style="border-radius: 10px; font-size: 30px; color: greenyellow;" class="fa-solid fa-check"></i></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="font-weight: 500; text-align: center;"><a style="color: black;"
                                                href="viewDetails"><i style="border-radius: 10px; font-size: 30px; color: red;" class="fa-solid fa-xmark"></i></a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
